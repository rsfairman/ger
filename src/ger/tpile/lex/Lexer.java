...
public class Lexer {
  ...
  private int readWholeNumber() throws ExpectedWholeNumberException {
    ...
    if (Character.isDigit(c) == false)
      throw new ExpectedWholeNumberException("expected whole number");
  ...
  private double readDouble() throws ExpectedFloatNumberException {
    ...
    if ((Character.isDigit(c) || (c == '+') || (c == '-') || (c == '.')) == false)
      throw new ExpectedFloatNumberException("expected decimal number");
  ...
  private Token readDCode() {
    ...
    try {
      ...
      answer.error = "malformed reference to D register";
    }
    return answer;
  }
  ...
  private Token readFCode() {
    ...
    try {
      ...
      answer.letter = Token.ERROR;
      answer.error = "malformed feed rate";
    }
    return answer;
  }
  ...
  private Token readHCode() {
    ...
    try {
      ...
      answer.letter = Token.ERROR;
      answer.error = "malformed reference to H register";
    }
    return answer;
  }
  ...
  private Token readICode() {
    ...
    try {
      ...
      answer.letter = Token.ERROR;
      answer.error = "malformed I-value";
    }
    return answer;
  }
  ...
  private Token readJCode() {
    ...
    try {
      ...
      answer.letter = Token.ERROR;
      answer.error = "malformed J-value";
    }
    return answer;
  }
  ...
  private Token readKCode() {
    ...
    try {
      ...
      answer.letter = Token.ERROR;
      answer.error = "malformed K-value";
    }
    return answer;
  }
  ...
  private Token readLCode() {
    ...
    try {
      ...
      answer.letter = Token.ERROR;
      answer.error = "malformed L-value";
    }
    return answer;
  }
  ...
  private Token readOCode() {
    ...
    try {
      ...
      answer.letter = Token.ERROR;
      answer.error = "malformed O-value";
    }
    return answer;
  }
  ...
  private Token readPCode() {
    ...
    try {
      ...
      answer.letter = Token.ERROR;
      answer.error = "malformed P-value";
    }
    return answer;
  }
  ...
  private Token readQCode() {
    ...
    try {
      ...
      answer.letter = Token.ERROR;
      answer.error = "malformed Q-value";
    }
    return answer;
  }
  ...
  private Token readRCode() {
    ...
    try {
      ...
      answer.letter = Token.ERROR;
      answer.error = "malformed R-value";
    }
    return answer;
  }
  ...
  private Token readSCode() {
    ...
    try {
      ...
      answer.letter = Token.ERROR;
      answer.error = "malformed spindle speed";
    }
    return answer;
  }
  ...
  private Token readTCode() {
    ...
    try {
      ...
      answer.letter = Token.ERROR;
      answer.error = "malformed T-value";
    }
    return answer;
  }
  ...
  private Token readUCode() {
    ...
    try {
      ...
      answer.letter = Token.ERROR;
      answer.error = "malformed U-value";
    }
    return answer;
  }
  ...
  private Token readXCode() {
    ...
    try {
      ...
      answer.letter = Token.ERROR;
      answer.error = "malformed X-value";
    }
    return answer;
  }
  ...
  private Token readYCode() {
    ...
    try {
      ...
      answer.letter = Token.ERROR;
      answer.error = "malformed Y-value";
    }
    return answer;
  }
  ...
  private Token readZCode() {
    ...
    try {
      ...
      answer.letter = Token.ERROR;
      answer.error = "malformed Z-value";
    }
    return answer;
  }
    ...
    if (c == Token.EOF)
    ...
    else if (c == '"')
      {
        ...
        try {
          ...
          answer.letter = Token.ERROR;
          answer.error = "multi-line strings not allowed";
        }
      }
    else
      {
        ...
        try {
          ...
          answer.letter = Token.ERROR;
          answer.error = "malformed number in argument to wizard";
        }
      }
    ...
    if (closed == CommentNotClosed)
      {
        ...
        answer.error = "comment not closed";
        return answer;
      }
    if (closed == CommentNested)
      {
        answer = new Token(Token.ERROR,lineCount);
        answer.error = "use of '(' inside comments not allowed.";
        return answer;
      }
