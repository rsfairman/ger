...
public class Token {
  ...
  // for v06.
  //
  // NOTE: If I firmly choose to abandon handling these kinds of G-codes, then
  ...
  // want to deal with them. OTOH, the ways these codes are defined can vary
  // from one machine to another. May be better to simply define my own
  // way of doing this since any choice will leave someone out, and 
  ...
  public String toString() {
    ...
    // NOTE: When I wrote this, I thought that end-users might want to look
    // at this output, but have changed my mind. It's still useful when
    // debugging during development. That's why this still includes the
    // line number. This output couldn't be parsed anyway.
