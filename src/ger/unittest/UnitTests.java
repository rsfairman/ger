...
//     ,"wizard_test_02"
  ...
  // it appears in the code for unit tests. This is mostly about converting
  // to the standard unit for the machine (inch or mm).
...
//  // For ThruWorkOffsets
//  private static String[] workOffsetsTests = {
//      
//  };
//
//  // For ThruPolar
//  private static String[] polarTests = {
//      
//  };
//
//  // For ThruIncremental
//  private static String[] incrementalTests = {
//      
//  };
//  
//  // For ThruCutterComp
//  private static String[] cutterCompTests = {
//      
//  };
  
  // For ThruPrerender
  private static String[] prerenderTests = {
      "prerender_test_01"
  };
...
//    runTests(workOffsetsTests,Translator.ThruWorkOffsets);
//    runTests(polarTests,Translator.ThruPolar);
//    runTests(incrementalTests,Translator.ThruIncremental);
//    runTests(cutterCompTests,Translator.ThruCutterComp);
    
    runTests(prerenderTests,Translator.ThruPrerender);
