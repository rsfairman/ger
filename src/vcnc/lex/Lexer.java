...
public class Lexer {
  ...
  public Lexer spinOff(int n,int assumedLine) {
    ...
    // given line number.
    Lexer answer = new Lexer();
    answer.theCode = theCode.spinOff(n);
    answer.lineCount = assumedLine;
    
    // Ready the buffer by filling it.
    answer.tokens = new TokenBuffer();
    answer.tokens.first = fillOneBuffer();
    answer.tokens.second = fillOneBuffer();
    return answer;
  }
